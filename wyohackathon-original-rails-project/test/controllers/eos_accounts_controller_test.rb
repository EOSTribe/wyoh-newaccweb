...
class EosAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create eos_account" do
    assert_difference('EosAccount.count') do
      post eos_accounts_url, params: { eos_account: { email: @eos_account.email, pubkey: @eos_account.pubkey, username: @eos_account.username } }
    end
  ...
  test "should update eos_account" do
    patch eos_account_url(@eos_account), params: { eos_account: { email: @eos_account.email, pubkey: @eos_account.pubkey, username: @eos_account.username } }
